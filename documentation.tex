...
Pour insérer une fonction avec précondition(s), il faut utiliser la commande \texttt{\textbackslash fonctionAvecPreconditions}  qui prend en paramètre six arguments :
\begin{lstlisting}
...
\paragraph{Avec Précondtitions}
\texttt{\textbackslash signatureFonctionAvecPreconditions} qui prend en paramètre quatre
arguments identiques aux quatre premiers paramètres de la commande \\
