...
%% Envoyer toutes remarques a Nicolas.Delestre@insa-rouen.fr
  ...
  \item Modifications depuis la version 2.4
    \textbullet Ajoute des commandes \typeProcedure, \typeFonction, \typeProcedureAvecPreconditions, \typeFonctionAvecPreconditions
  ...
  \item Modification depuis la version 2.3.6 :
    \textbullet Ajout des commandes \textbackslash fonctionAvecPreconditions
    \textbullet \textbackslash signatureFonctionAvecPreconditions, \textbackslash procedureAvecPreconditions et \textbackslash signatureProcedureAvecPreconditions
    \textbullet remplacement de structure et champStructure par enregistrement et champEnregistrement
  ...
  \item  Modification depuis la version 2.3.2 : 
   ...
   \textbullet   structure est maintenant un environnement qui s'integre dans l'environnement algorithme
    \textbackslash champStructure a pris une majuscule  
...
\begin{algorithme}
\begin{structure}{noeud}
  \champStructure{lElement}{Element}
  \champStructure{listeSuivante}{listeChaînée}
\end{structure}
\end{algorithme}
...
\section{L'environment structure}
